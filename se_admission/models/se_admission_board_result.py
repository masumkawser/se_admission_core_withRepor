...
class OpAdmissionBoardResultGeneral(models.Model):
    _name = "se.admission.board.result.general"
    ...
    #     comodel_name='se.admission', string='Admission Application')


# class OpAdmissionBoardResultEnglish(models.Model):
#     _name = "se.admission.board.result.english"
...
#         stored=True
#     )
#     subject_id = fields.Many2one(comodel_name='se.subject', string='Subject', domain=[
#                                  '|', '&', ('admission_form_subject_type', '=', 'o_level'), ('admission_form_subject_type', '=', 'a_level'), ('is_allow_admission_form', '=', True)])
#     extra_subject_id = fields.Many2one(
#         comodel_name='opd.subject.extra', string='Subject')
#     grade = fields.Char(string='Grade')
...
# class OpAdmissionBoardResultAll(models.Model):
#     _name = "se.admission.board.result.all"
...
#     educational_board_id = fields.Many2one(comodel_name='op.education.board', string='Educational Board',
#                                            domain=[
#                                                '|', '|', '|', '|', '|', '|',
...
#         stored=True
#     )
#     admission_board_result_marksheet = fields.Binary(
#         string='Marksheet', attachment=True, store=True, help="Attach all the Academic Marksheet as PDF/JPG/JPEG.")
#     admission_board_result_certificate = fields.Binary(
#         string='Certificate', attachment=True, store=True, help="Attach all the Academic Certificate as PDF/JPG/JPEG.")
#     admission_id = fields.Many2one(
#         comodel_name='op.admission', string='Admission Application')
...
#         openeducat_admission_year_range_start = self.env['ir.config_parameter'].sudo(
#         ).get_param('openeducat_admission.year_range_start')
#         openeducat_admission_year_range_end = self.env['ir.config_parameter'].sudo(
#         ).get_param('openeducat_admission.year_range_end')
